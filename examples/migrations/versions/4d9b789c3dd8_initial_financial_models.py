...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_documents_related_account_id'), 'documents', ['related_account_id'], unique=False)
    op.create_index(op.f('ix_documents_related_transaction_id'), 'documents', ['related_transaction_id'], unique=False)
    ...
    op.create_index(op.f('ix_goals_linked_account_id'), 'goals', ['linked_account_id'], unique=False)
