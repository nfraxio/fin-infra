...
class TestBankingTransactionFiltering:
    ...
    def test_filter_by_category(self, client):
        ...
        response = client.get(
            "/banking/transactions?category=food",
            headers={"Authorization": "Bearer test_token"}
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_filter_by_min_amount_only(self, client):
        ...
        response = client.get(
            "/banking/transactions?min_amount=50",
            headers={"Authorization": "Bearer test_token"}
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_filter_by_max_amount_only(self, client):
        ...
        response = client.get(
            "/banking/transactions?max_amount=10",
            headers={"Authorization": "Bearer test_token"}
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_filter_by_account_id(self, client):
        ...
        response = client.get(
            "/banking/transactions?account_id=acc_1",
            headers={"Authorization": "Bearer test_token"}
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_invalid_per_page_above_max(self, client):
        ...
        response = client.get(
            "/banking/transactions?per_page=500",
            headers={"Authorization": "Bearer test_token"}
        )
