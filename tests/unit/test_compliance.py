...
def test_log_compliance_event_without_context(caplog):
    ...
    compliance_record = next(
        r for r in caplog.records if "minimal.event" in r.message
    )
